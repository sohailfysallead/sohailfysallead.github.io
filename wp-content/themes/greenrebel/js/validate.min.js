  ...
  e.extend(e.fn, {
    ...
    rules: function(t, i) {
      if (this.length) {
        ...
        if (t)
          switch (
            ((s = e.data(n.form, "validator").settings),
            (a = s.rules),
        ...
        return (
          (r = e.validator.normalizeRules(
            e.extend(
              {},
              e.validator.classRules(n),
              e.validator.attributeRules(n),
              e.validator.dataRules(n),
              e.validator.staticRules(n)
            ),
            n
          )),
          r.required &&
            ((l = r.required),
            delete r.required,
            (r = e.extend({ required: l }, r)),
            e(n).attr("aria-required", "true")),
          r.remote &&
            ((l = r.remote), delete r.remote, (r = e.extend(r, { remote: l }))),
          r
        );
      }
    }
    ...
    e.extend(e.validator, {
      ...
      prototype: {
                ...
                r &&
                  e.each(this.groups, function(e, t) {
                    t === r &&
                      ...
                      i &&
                        i.name in s.invalid &&
                        (s.currentElements.push(i), (a = a && s.check(i))));
                  }),
                (o = this.check(n) !== !1),
                (a = a && o),
                o ? (this.invalid[n.name] = !1) : (this.invalid[n.name] = !0),
        ...
        elementValue: function(t) {
          ...
          return "radio" === n || "checkbox" === n
            ? this.findByName(t.name)
                .filter(":checked")
                .val()
            : "number" === n && "undefined" != typeof t.validity
            ? t.validity.badInput
              ? "NaN"
              : i.val()
            : ((s = t.hasAttribute("contenteditable") ? i.text() : i.val()),
              "file" === n
        ...
        check: function(t) {
          ...
          if ("function" == typeof i.normalizer) {
            if (((a = i.normalizer.call(t, a)), "string" != typeof a))
              throw new TypeError(
          ...
          for (r in i) {
            l = { method: r, parameters: i[r] };
            try {
              if (
                ((o = e.validator.methods[r].call(this, a, t, l.parameters)),
        ...
        errorsFor: function(t) {
          ...
          return (
            n && (s = s + ", #" + this.escapeCssMeta(n).replace(/\s+/g, ", #")),
      ...
      attributeRules: function(t) {
        ...
        for (a in e.validator.methods)
          "required" === a
            ? ((o = t.getAttribute(a)), "" === o && (o = !0), (o = !!o))
            : (o = n.attr(a)),
            this.normalizeAttributeRule(i, s, a, o);
        return (
          i.maxlength &&
      ...
      methods: {
        ...
        remote: function(t, i, n, s) {
          ...
          var o,
            r,
            l,
            a = this.previousValue(i, s);
          return (
            this.settings.messages[i.name] ||
              (this.settings.messages[i.name] = {}),
            (a.originalMessage =
              a.originalMessage || this.settings.messages[i.name][s]),
            (this.settings.messages[i.name][s] = a.message),
            (n = ("string" == typeof n && { url: n }) || n),
            (l = e.param(e.extend({ data: t }, n.data))),
            a.old === l
              ? a.valid
              : ((a.old = l),
                (o = this),
                    ...
                    !0,
                    {
                      ...
                      success: function(e) {
                        var r,
                          ...
                          p,
                          n = e === !0 || "true" === e;
                        (o.settings.messages[i.name][s] = a.originalMessage),
                          n
                            ? ((p = o.formSubmitted),
                              o.resetInternals(),
  ...
  e.ajaxPrefilter
    ...
    : ((i = e.ajax),
      (e.ajax = function(n) {
        ...
        return "abort" === s
          ? (t[a] && t[a].abort(), (t[a] = i.apply(this, arguments)), t[a])
